...
class ToolDefaults {
    ...
    static func getColor(type: ToolType) -> UIColor? {
        ...
        case .marker: return UIColor(red: 255, green: 230, blue: 32, alpha: 1)
        case .neon: return UIColor(red: 50, green: 254, blue: 186, alpha: 1)
        case .pencil: return UIColor(red: 45, green: 136, blue: 243, alpha: 1)
        default: return nil
        }
    }
